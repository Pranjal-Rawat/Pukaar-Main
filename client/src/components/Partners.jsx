        ...
        <div id="partners" className='mt-4'>
            <section className="bg-white lg:pb-6">
                <div className="max-w-7xl mx-auto p-4 sm:p-3 lg:p-1">
                    <div id='' className="container mx-auto px-3  bg-white">

                        <div className="mb-4 text-center">
                            <h4 className="text-base text--600 font-semibold tracking-wide uppercase">Our Partners</h4>
                        ...
                        <div className="flex flex-wrap my-12">
                            ...
                            <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-4">
                                <div className="flex items-center mb-6">
                                    ...
                                    <div className="ml-4 text-xl heading">Project Purkul</div>
                                </div>
                            ...
                            <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-4">
                                <div className="flex items-center mb-6">
                                    ...
                                    <div className="ml-4 text-xl heading">Gyanoday</div>
                                </div>
                                <p className="leading-loose text-gray-500">Gyanoday works towards the upliftment of the neglected and marginalised sections of the society. Since 2001, we have been striving to ensure that individuals and children from these communities are given the opportunity to grow into constructive and self-sufficient citizens of tomorrow by creating a nurturing environment for them today..</p>
                            </div>

                            <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-4">
                                <div className="flex items-center mb-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="20" height="20"
                                        fill="currentColor" className="h-6 w-6 text--500">
                                        <path
                        ...
                        <div className="flex flex-wrap ">
                            ...
                            <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-4">
                                <div className="flex items-center mb-6">
                                    ...
                                    <div className="ml-4 text-xl heading">Ucost</div>
                                </div>
                            ...
                            <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-4">
                                <div className="flex items-center mb-6">
                                    ...
                                    <div className="ml-4 text-xl heading">Giri Foundation</div>
                                </div>
                            ...
                            {/* Villas Section */}
                            <div id='' className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-4">
                                <div className="flex items-center mb-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="20" height="20"
                                        fill="currentColor" className="h-6 w-6 text--500">
                                        <path
                                    ...
                                    <div className="ml-4 text-xl heading">Proect Aina</div>
                                </div>
